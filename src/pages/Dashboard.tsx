    ...
    switch (activeSection) {
      ...
      case 'sales':
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-glow">Centro de Operaciones y Ventas</h2>
              <p className="text-muted-foreground">Ventas directas, pedidos online, órdenes manuales y servicio técnico</p>
            </div>
